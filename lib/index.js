// dsh-jdpatterns v3.1 — 设计模式参考库（host 半）
// 适配 dsh 0.1.5-alpha.1：核验 tools/pre-execute、post-execute waterfall、systemPrompt.section、
// webServer exact 路由、ctx.fs.resolve/contains、createUserMessage form:'notice' 契约均未变。
